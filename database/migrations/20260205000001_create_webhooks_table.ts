...
export async function up(knex: Knex): Promise<void> {
  ...
  // bypassing knex's applied-migrations tracking. An earlier version of this
  // migration dropped and recreated both tables here, which destroyed all
  // production webhook configuration when an old template was applied.
